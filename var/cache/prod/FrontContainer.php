...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\wamp64\\www\\four\\modules\\productcomments\\src\\Entity']);
        $e->addExcludePaths([0 => 'C:\\wamp64\\www\\four\\modules\\productcomments\\src\\Entity/index.php']);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\wamp64\\www\\four\\modules\\ps_checkout\\src\\Entity']);
        $f->addExcludePaths([0 => 'C:\\wamp64\\www\\four\\modules\\ps_checkout\\src\\Entity/index.php']);

        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\wamp64\\www\\four\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $c->addDriver($e, 'PrestaShop\\Module\\ProductComment\\Entity');
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'C:\\wamp64\\www\\four\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        ...
        $a->setProxyDir('C:\\wamp64\\www\\four/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\wamp64\\www\\four', 'C:\\wamp64\\www\\four/modules/');
    }
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\four/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\four/var/cache/prod\\/localization'))));
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.0.2', 'C:\\wamp64\\www\\four', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('8.0.2', 'C:\\wamp64\\www\\four');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\wamp64\\www\\four/app',
            'kernel.project_dir' => 'C:\\wamp64\\www\\four',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\wamp64\\www\\four/var/cache/prod\\',
            ...
            'ps_cache_dir' => 'C:\\wamp64\\www\\four/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\wamp64\\www\\four/var/cache/prod\\/doctrine/orm/Proxies',
